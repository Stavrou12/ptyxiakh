 ...
 * @author gnnss
 */
public class RemoveTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoveTable</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RemoveTable at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    PrintWriter out = response.getWriter();
        ...
        String selectedmonth = request.getParameter("month-select-2");
        String selectedyear = request.getParameter("year-select-2");
        try {
         ...
         boolean isTableRemoved = removeTableFromDatabase(tableName);
     ...
     private boolean removeTableFromDatabase(String tableName) {
